VideoCanvas.prototype = new BasicCanvas();
...
VideoCanvas.prototype.construct = function(_data)
{
	...
	BasicCanvas.prototype.construct.call(this,_data);
}

VideoCanvas.prototype.update = function()
{
	BroadcastCenter.sendEvent(this.data.children("onUpdate").prop("outerHTML"));
	if(this.video.get(0).ended)
	{
		BroadcastCenter.sendEvent(this.data.children("onComplete").prop("outerHTML"));
	}
}

VideoCanvas.prototype.handleSpecialNode = function(nodeName,nodeValue)
{
	var isSpecial = BasicCanvas.prototype.handleSpecialNode.call(this,nodeName,nodeValue);
	switch(nodeName.toLowerCase())
	{
		...
		case "height":
			...
			break;
		case "src":
			nodeValue = CoreURL.app+nodeValue;
			this.video.attr(nodeName,nodeValue);
			isSpecial = true;
			break;
		case "autoplay":
...
VideoCanvas.prototype.initEvents = function()
{
	...
	BroadcastCenter.addEventListener(VideoEvent.prototype.type,function(event,data){
